...
{
	float c1 = cosf(TORADIANS(euler[0]) / 2.f);
	float s1 = sinf(TORADIANS(euler[0]) / 2.f);
	float c2 = cosf(TORADIANS(euler[1]) / 2.f);
	float s2 = sinf(TORADIANS(euler[1]) / 2.f);
	float c3 = cosf(TORADIANS(euler[2]) / 2.f);
	float s3 = sinf(TORADIANS(euler[2]) / 2.f);
	float c1c2 = c1 * c2;
	float s1s2 = s1 * s2;
